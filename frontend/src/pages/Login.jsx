...
const Login = () => {
    ...
    const handleGoogleLogin = async () => {
        // Mocking Google OAuth via AuthContext
        if (googleLogin) {
        ...
        <div className="min-h-screen relative overflow-hidden flex items-center justify-center bg-[#050a06] aurora-bg animate-aurora">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-black tracking-tight text-white mb-2">Orionify</h2>
                    <p className="text-gray-400 text-sm font-medium">Log in to your workspace.</p>
                </div>
                ...
                <div className="glass-panel p-8 relative overflow-hidden bg-[#0a140d]/80 rounded-3xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex justify-end pt-2 pb-2">
                            <Link to="/forgot-password" className="text-xs font-bold text-[#6ee71c] hover:text-[#8cf53a] transition-colors">Forgot password?</Link>
                        </div>

                        <button
                            type="submit"
                            className="w-full py-4 glass-btn-primary mt-2 text-[15px] rounded-xl"
                        >
                            Sign In
                        </button>
                ...
                <div className="mt-8 flex items-center justify-between px-4">
                    ...
                    <Link to="/signup" className="text-sm font-bold text-[#6ee71c] hover:text-[#8cf53a] transition-colors">
                        Create free account
                    </Link>
                </div>
            </motion.div>
